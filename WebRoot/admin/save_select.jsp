...
<%
	...
	for(int i=1;i<=sumCount;i++){
		...
		SelectDiff sd=bf.SearchSelectDiff("where id='"+id+"'");
		sd.setD1_r(d11);
		sd.setD2_r(d22);
		sd.setD3_r(d33);
		sd.setD4_r(d44);
		...
		SelectChp s=bf.SearchSelectChp("where id='"+id+"'");
		s.setChp_r(chp_r);
		s.setId(id);
		Connection con = null;
		...
		ps = con.prepareStatement(FinalConstants.UPDATE_SELECTCHP);
		ps1=con.prepareStatement(FinalConstants.UPDATE_SELECTDIFF);
